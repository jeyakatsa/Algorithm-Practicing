...
//values to the right by that amount. ‘Wrap-around’ any values that shift off array’s 
//end to the other side, so that no data is lost. Operate in-place: given ([1,2,3],1), 
...
//elements. Do not alter the original arrays. Ex.: arrConcat( ['a','b'], [1,2] )
